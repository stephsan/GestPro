    ...
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-dark"><a href="{{route('permissions.index')}}">permissions</a></li>
                <li class="breadcrumb-item active text-dark active">Ajout une nouvelle permission</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
