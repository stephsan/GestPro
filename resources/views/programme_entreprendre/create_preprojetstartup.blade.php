                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="offset-md-1 col-lg-5">
                                    ...
                                    <div class="form-group{{ $errors->has('doc_projet') ? ' has-error' : '' }}">
                                        <label class=" control-label" for="docidentite">Joindre le document synthétique du projet(5 pages max) <span data-toggle="tooltip" title="joindre un document synthétique d’au moins 3 à 5 pages max avec plus de detail de votre projet."><i class="fa fa-info-circle"></i><span class="text-success">*</span></span> : </label>
            ...
            <div class="row">
                    <div class="col-md-10">
                        <div class="form-group{{ $errors->has('engagement') ? ' has-error' : '' }}" >
                            <label class=" control-label" for="engagement">Joindre une copie scannée de l'engagement(en pdf,jpeg,png) <span data-toggle="tooltip" title="joindre une copie scannée de l'engagement."><i class="fa fa-info-circle"></i><span class="text-danger">*</span></span> : </label>
