                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-label" for="val_username">Etablissement fréquenté (<span class="text-danger">*</span>)</label>
                                            <div class="input-group">
                                                <input type="text" id="etablissement" name="etablissement" class="form-control" placeholder="Votre établissement.." >
                                                <span class="input-group-addon"><i class="gi gi-user"></i></span>
                                            </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="val_username">Classe (<span class="text-danger">*</span>)</label>
                                            <div class="input-group">
                                                <!-- <input type="text" id="classe" name="classe" class="form-control" placeholder="Votre classe.." > -->
                                                <select name="classe" id="sexe" class="form-control" >
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-label" for="val_username">Date de naissance (<span class="text-danger">*</span>)</label>
                                            <div class="input-group">
                                                <input type="date" id="date_naissance" min="2008-01-01" max="2014-12-31" name="date_naissance" class="form-control" >
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">                                
                                        <label class="form-label" for="val_skill">L'enfant a t-il dejà participé à la colonie? (<span class="text-danger">*</span>)</label>
                                            <select id="niveau" name="niveau" class="form-control"  title="Le champs est obligatoire" >
                                                <option value=""></option>
                                    ...
                                    <div class="form-group">                                
                                        <label class="form-label" for="val_skill">Région (<span class="text-danger">*</span>)</label>
                                            <select id="region" name="region" class="form-control"  title="Le champs region est obligatoire"  value="{{old("region")}}" onchange="changeValue('region', 'province', {{ env('PARAMETRE_ID_PROVINCE') }});" >
                                            <option value="">Choisir</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">                                
                                        <label class="form-label" for="val_skill">Province (<span class="text-danger">*</span>)</label>
                                            <select id="province" name="province" class="form-control"  title="Le champs region est obligatoire" data-placeholder="Choisir votre residence .."  onchange="changeValue('province', 'commune', {{ env('PARAMETRE_ID_COMMUNE') }});" >
                                            <option value="">Choisir</option>
                                    ...
                                    <!-- <div class="form-group">                                
                                        <label class="form-label" for="val_skill">Comune (<span class="text-danger">*</span>)</label>
                                            <select id="commune" name="commune" class="form-control"  title="Le champs region est obligatoire" data-placeholder="Choisir votre residence .." onchange="changeValue('commune', 'arrondissement', {{ env('PARAMETRE_ID_ARRONDISSEMENT') }});" >
                                            <option value="">Choisir</option>
