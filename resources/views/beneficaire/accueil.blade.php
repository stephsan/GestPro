...
@section('css')
@endsection
@section('profil_beneficiaire', 'active')
@section('content')
                        ...
                        <div class="card card-success card-tabs">
                          <div class="card-header p-0 pt-1">
                            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                              <li class="nav-item">
                                <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Ma personne</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-one-chiffre-tab" data-toggle="pill" href="#custom-tabs-one-entreprise" role="tab" aria-controls="custom-tabs-one-settings" aria-selected="false">Informations sur mon entreprise</a>
                              </li> 
                              <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-one-profile-tab" data-toggle="pill" href="#custom-tabs-one-profile" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">Informations sur mon avant-projet</a>
                              </li>
