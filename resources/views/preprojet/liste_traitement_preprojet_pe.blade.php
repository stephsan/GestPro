...
@section('content')
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item text-dark">Programme Entreprendre {{ $type }}</li>
                ...
                @foreach ($preprojets as $preprojet)
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a 
                                 href="{{ route('preprojet_pe.details', $preprojet) }}?type_detail=analyser" data-toggle="tooltip" title="Analyser l'avant projet" class="btn btn-xs btn-default"><i class="fa fa-eye"></i></a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('excel.chargerEvaluationPe') }}" enctype="multipart/form-data" >
                    @csrf
