...
<div id="modal-plainte-desc"class="modal fade" role="dialog">
          ...
          <div class="row">
            <div style="margin-top:20px;" class="col-md-12" >
                ...
                <div class="row" style="font-size:22px; text-align:justify; padding:20px; color:rgb(48, 50, 48)">
                  ...
                  <a class="btn btn-danger elementor-button" style="margin-left:40%"   href="{{ route('plainte.accueil') }}">ENREGISTRER LA PLAINTE</a>
