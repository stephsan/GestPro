...
var FormsWizard = function() {
    ...
    return {
		...
		if (data.currentStep === 'progress-first') {
            ...
            $('#advanced-wizard').formwizard({
                ...
                validationOptions: {
                    ...
                    messages: {
                        ...
                        val_email: 'Veuillez entrer une adresse email',
            ...
            clickableWizard.formwizard({disableUIStyles: true, 
             validationEnabled: true,
                validationOptions: {
                    errorClass: 'help-block animation-slideDown', // You can change the animation class for a different entrance animation - check animations page
                    errorElement: 'span',
                    ...
                    messages: {
                        titre: {
                            required: 'Renseigner le titre du projet',
                            minlength: 'Le titre du projet doit avoir au moins deux caractères'
                        },
                        val_password: {
                            required: 'Please provide a password',
                            minlength: 'Your password must be at least 5 characters long'
