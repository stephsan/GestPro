...
var FormsWizard = function() {
    ...
    return {
        init: function() {
            ...
            $('#progress-wizard').formwizard({focusFirstInput: false, disableUIStyles: true, validationEnabled: true,
                validationOptions: {
                    ...
                    messages: {
                        ...
                        nombre_annee_experience: {
                            required: 'Ce champ est obligatoires',
                            number: 'Entrez SVP un nombre',
                            max: 'Entrez SVP un nombre inférieur à 100'
                        },
                        val_confirm_password: {
                            required: 'Please provide a password',
                            minlength: 'Your password must be at least 5 characters long',
            ...
            $('.advanced-wizard').formwizard({
                ...
                validationOptions: {
                    ...
                    messages: {
                        ...
                        val_email: ' Entrer une adresse email valide SVP ',
                        val_terms: 'Please accept the terms to continue'
                    }
                },
                inDuration: 0,
